      ...
      <div className='banner' id='home'>
        <div className='slider' style={{ '--quantity': 16 }}>
          ...
          <div className='item' style={{ '--position': 2 }}>
            <img
              src='../../../public/prewed.png'
              alt='Prewed'
            />
          </div>
          <div className='item' style={{ '--position': 3 }}>
            <img
              src='../../../public/wedding.png'
              alt='Wedding'
            />
          </div>
          <div className='item' style={{ '--position': 4 }}>
            <img
              src='../../../public/produk.png'
              alt='Produk'
            />
          </div>
          <div className='item' style={{ '--position': 5 }}>
            <img
              src='../../../public/wisuda.png'
              alt='Graduation'
            />
          </div>
          <div className='item' style={{ '--position': 6 }}>
            <img
              src='../../../public/wedding-2.png'
              alt='Wediing'
            />
          </div>
          <div className='item' style={{ '--position': 7 }}>
            <img
              src='../../../public/produk-2.png'
              alt='Produk'
            />
          </div>
          <div className='item' style={{ '--position': 8 }}>
            <img
              src='../../../public/wisuda-2.png'
              alt='Graduation'
            />
          </div>
          <div className='item' style={{ '--position': 9 }}>
            <img
              src='../../../public/wedding-3.png'
              alt='Wedding'
            />
          </div>
          ...
          <div className='item' style={{ '--position': 13 }}>
            <img
              src='../../../public/wedding-6.png'
              alt='Wedding'
            />
          </div>
          <div className='item' style={{ '--position': 14 }}>
            <img
              src='../../../public/wisuda-3.png'
              alt='Graduation'
            />
          </div>
